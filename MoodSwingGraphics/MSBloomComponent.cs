...
{
    public class MSBloomComponent : DrawableGameComponent
    {
        #region Fields
        ...
        public MSBloomSettings Settings { set; get; }
        ...
        public MSBloomComponent(Game game)
            : base(game)
        {
            if (game == null)
                throw new ArgumentNullException("game");

            Settings = MSBloomSettings.PresetSettings[5];
        }
