...
namespace MoodSwingGraphics
{
    ...
    /// </summary>
    public abstract class MSParticleSystem : DrawableGameComponent
    {
        #region Fields


        // Settings class controls the appearance and animation of this particle system.
        MSParticleSettings settings = new MSParticleSettings();
        ...
        /// Constructor.
        /// </summary>
        protected MSParticleSystem(Game game)
            : base(game)
        {
        ...
        public override void Initialize()
        {
            ...
            particles = new MSParticleVertex[settings.MaxParticles * 4];
        ...
        protected override void LoadContent()
        {
            ...
            vertexBuffer = new DynamicVertexBuffer(GraphicsDevice, MSParticleVertex.VertexDeclaration,
        ...
        {
            int stride = MSParticleVertex.SizeInBytes;
